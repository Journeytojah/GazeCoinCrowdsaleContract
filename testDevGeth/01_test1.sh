...
// pause(deployLibBTTSMessage, 1);
// currentBlock = waitOneBlock(currentBlock);

// tokenFactoryLibBTTSAddress = eth.getTransactionReceipt(tokenFactoryLibBTTSTx).contractAddress;
// addAccount(tokenFactoryLibBTTSAddress, "BTTS Library");
// console.log("DATA: tokenFactoryLibBTTSAddress=" + tokenFactoryLibBTTSAddress);
...
// pause(deployTokenFactoryMessage, 1);
// currentBlock = waitOneBlock(currentBlock);

// tokenFactoryAddress = eth.getTransactionReceipt(tokenFactoryTx).contractAddress;
// tokenFactory = eth.contract(tokenFactoryAbi).at(tokenFactoryAddress);
// addAccount(tokenFactoryAddress, "BTTSTokenFactory");
// addTokenFactoryContractAddressAndAbi(tokenFactoryAddress, tokenFactoryAbi);
// console.log("DATA: tokenFactoryAddress=" + tokenFactoryAddress);
